    ...
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <Section titre="📜 Journal de partie — la chronique s'écrit toute seule">
          ...
          <Row label="Consulter le journal">Cliquez <span className="bg-stone-800 border border-stone-600 text-stone-300 px-1.5 py-0.5 rounded text-xs">📜 Journal</span> en haut de la section Combat. Un panneau s'ouvre avec la chronologie : une ligne par action, avec l'heure, regroupées par journée de jeu (une soirée qui déborde après minuit reste dans la même journée).</Row>
          ...
          <Row label="Rounds de combat">Dans le panneau du journal, les boutons <span className="bg-red-900/40 text-red-300 px-1.5 py-0.5 rounded text-xs">⚔ Combat !</span>, <span className="bg-amber-900/40 text-amber-300 px-1.5 py-0.5 rounded text-xs">▶ Round suivant</span> et <span className="bg-stone-800 text-stone-300 px-1.5 py-0.5 rounded text-xs">🕊 Fin</span> insèrent des marqueurs de round. Ces marqueurs sont <strong>partagés par toute la table</strong> : un seul joueur (ou le MJ) les pose, tout le monde les voit.</Row>
