    ...
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <Section titre="🛡️ Sorts actifs sur la CA">
          <p>Certains sorts modifient temporairement la classe d'armure — <strong className="text-amber-200">Armure de mage</strong> (+4), <strong className="text-amber-200">Bouclier</strong> (+4), <strong className="text-amber-200">Bouclier de la foi</strong>, <strong className="text-amber-200">Peau d'écorce</strong>, etc. Comme le temps de jeu ne correspond pas au temps réel, c'est <strong>vous</strong> qui décidez quand l'effet commence et quand il prend fin.</p>
          <Row label="Activer un effet">Lancez simplement le sort avec son bouton <span className="bg-amber-900/40 border border-amber-800/40 text-amber-400 px-1.5 py-0.5 rounded text-xs font-mono">préparé ▶</span> dans la section Sorts. Si le sort affecte la CA, l'effet s'active automatiquement : une étiquette violette apparaît dans la section Combat, la CA est recalculée (détail <span className="font-mono text-stone-400">· sorts +N</span>) et le sort porte le badge <span className="bg-violet-900/40 border border-violet-700 text-violet-300 px-1.5 py-0.5 rounded text-xs">🛡 actif</span>. Seuls les sorts que vous avez <strong>préparés</strong> (étudiés ou priés) peuvent donc être lancés. Pour Bouclier de la foi et Peau d'écorce, le bonus est calculé automatiquement selon votre niveau de lanceur.</Row>
          <Row label="Retirer un effet">Quand le sort prend fin dans le jeu, cliquez le <span className="font-mono text-stone-500">✕</span> sur l'étiquette violette dans la section Combat. La CA revient à sa valeur normale.</Row>
