    ...
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <Section titre="🛡️ Sorts actifs — CA et caractéristiques">
          ...
          <Row label="Retirer un effet">Quand le sort prend fin dans le jeu, cliquez le <span className="font-mono text-stone-500">✕</span> sur l'étiquette violette dans la section Combat. Tout revient instantanément à la normale.</Row>
