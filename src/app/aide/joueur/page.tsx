    ...
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <Section titre="🛡️ Sorts actifs — CA et caractéristiques">
          ...
          <Row label="Sorts de lumière">Lancez <strong className="text-amber-200">Lumière</strong> ou <strong className="text-amber-200">Lumière du jour</strong> : une étiquette dorée <span className="bg-yellow-900/30 border border-yellow-600/70 text-yellow-200 px-1.5 py-0.5 rounded text-xs">☀</span> apparaît dans Sorts actifs et un <strong>halo lumineux</strong> entoure le portrait du personnage. Aucune statistique n'est modifiée — c'est purement visuel.</Row>
