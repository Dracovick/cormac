    ...
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <Section titre="🏛 Classes de prestige">
          <p>Le menu des classes contient maintenant <strong className="text-amber-200">94 classes de prestige</strong> : Guide du Maître (15 — Archimage, Assassin, Chevalier noir, Théurge mystique…), Codex Divin (24), Codex Profane (19), Les Maîtres de la Nature (18) et Manuel des Joueurs de Faerûn (18). Elles apparaissent dans le groupe <strong>« Classes de prestige »</strong> du sélecteur, avec leur livre d'origine entre parenthèses.</p>
