    ...
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <Section titre="🧙 Onglet Sorts — grimoire et préparations">
          ...
          <Tip>Le catalogue inclut maintenant <strong>près de 300 sorts de suppléments</strong> : Royaumes Oubliés (38), Codex Divin (~110 : Vigueur, Souffle de dragon, Visage divin…), Codex Profane (~100 : les Orbes, Armure de mage suprême, Invisibilité supérieure…) et Maîtres de la Nature (~35 : Force du chêne, Bosquet druidique…). Chaque sort indique son livre source entre crochets à la fin de sa description, ex. « [Codex Divin] ».</Tip>
        ...
        <Section titre="🎯 Onglet Dons — sélecteur par catégorie">
          ...
          <Tip>Le catalogue inclut maintenant <strong>plus de 130 dons de suppléments</strong> : Codex Divin (40 : dons divins de renvoi, forme animale…), Codex Profane (dons draconiques, métamagie soudaine…), Maîtres de la Nature (rage, robustesse, ennemis jurés…) et les dons régionaux des Royaumes Oubliés (Éducation, Chance des héros, Magie de la Toile d'Ombre…). Le livre source est indiqué entre crochets à la fin de chaque description.</Tip>
