...
export const SORTS_EFFETS_CA: EffetCACatalogue[] = [
  ...
  { nom: 'Bouclier de la foi',       typeBonus: 'parade',              valeur: 2, valeurMax: 5, duree: '1 min/niveau',    note: '+2, +1 par 6 niveaux de lanceur au-delà du 1er (max +5).' },
  ...
  { nom: 'Peau d\'écorce',           typeBonus: 'armure naturelle',    valeur: 2, valeurMax: 5, duree: '10 min/niveau',   note: '+2, +1 par 3 niveaux de lanceur au-delà du 3e (max +5 au 12e).' },
